  ...
  return (
    <div style={{ minHeight: '100dvh', background: c.bg, fontFamily: "'Inter', system-ui, sans-serif" }}>
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '48px 20px 80px' }}>
        <h1 style={{ fontSize: 'clamp(28px, 5vw, 44px)', fontWeight: 900, letterSpacing: '-1px', color: c.text, marginBottom: 10, lineHeight: 1.1 }}>
          O que você precisa?
        </h1>
        <p style={{ fontSize: 'clamp(14px, 2vw, 16px)', color: c.text2, lineHeight: 1.6, marginBottom: 28, maxWidth: 480 }}>
          Descreva o serviço, informe seu endereço e publique. Profissionais da sua região entram em contato com você.{' '}
          <Link href="/feed" style={{ color: c.amber, textDecoration: 'none', fontWeight: 600 }}>Ver pedidos →</Link>
        </p>
